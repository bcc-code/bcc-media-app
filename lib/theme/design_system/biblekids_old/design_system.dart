...
class OldBibleKidsDesignSystem extends DesignSystemData {
  OldBibleKidsDesignSystem._raw({
  ...
  factory OldBibleKidsDesignSystem() {
    final colors = _Colors();
    final textStyles = BccMediaTextStyles(colors: colors);
    return OldBibleKidsDesignSystem._raw(
      colors: colors,
