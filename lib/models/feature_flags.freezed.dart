...
class _$FeatureFlagsImpl extends _FeatureFlags {
  ...
  @override
  String toString() {
    return 'FeatureFlags(toggles: $toggles, auth: $auth, publicSignup: $publicSignup, socialSignup: $socialSignup, autoplayNext: $autoplayNext, autoFullscreenOnPlay: $autoFullscreenOnPlay, shareVideoButton: $shareVideoButton, gamesTab: $gamesTab, flutterPlayerControls: $flutterPlayerControls, playNextButton: $playNextButton, chapters: $chapters, chaptersFirstTab: $chaptersFirstTab, download: $download, shorts: $shorts, shortsSourceButtonPrimary: $shortsSourceButtonPrimary, shortsSharing: $shortsSharing, shortsHideAutoGenerated: $shortsHideAutoGenerated)';
  }
...
abstract class _FeatureFlags extends FeatureFlags {
  const factory _FeatureFlags(
      ...
      final bool shortsSourceButtonPrimary,
      final bool shortsSharing,
      final bool shortsHideAutoGenerated}) = _$FeatureFlagsImpl;
