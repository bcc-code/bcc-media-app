...
class SFr extends S {
  ...
  String get loginPageDisplay2 =>
      'Regarde des séries, des émissions et des films basés sur les valeurs chrétiennes';
  ...
  String get bccMediaCenter =>
      'BrunstadTV est un média à caractère non lucratif qui produit et distribue du contenu basé sur des valeurs positives et chrétiennes.';
  ...
  String get loggedOutMessage =>
      'Tu as été déconnecté. Merci de te connecter à nouveau.';
  ...
  String get loginFailedCheckNetwork =>
      'Échec de la connexion. Vérifie ta connexion internet et retente à nouveau.';
  ...
  String get checkNetwork =>
      'Vérifie ta connexion internet et retente à nouveau.';
  ...
  String get livestreamMaintenance =>
      'Désolés, la diffusion en direct est en maintenance pour le moment. Merci de retenter plus tard.';
  ...
  String get emptySearch =>
      'Tu peux faire une recherche sur tout le contenu de BrunstadTV. Séries, films et épisodes.';
  ...
  String get recordingTips =>
      'Quelques recommandations pour avoir un bel enregistrement';
  ...
  String get recordingTipB =>
      'Veille à ce que ton visage soit éclairé de manière uniforme.';

  @override
  String get recordingTipC =>
      'Pense à ce que tu souhaites dire avant de commencer l\'enregistrement.';
  ...
  String get recordVideoCameraPermissionAlert =>
      'Tu dois autoriser l\'utilisation de la caméra dans les paramètres d\'enregistrement vidéo.';

  @override
  String get recordVideoPhotosPermissionAlert =>
      'Tu dois autoriser l\'utilisation de la galerie dans les paramètres d\'enregistrement vidéo.';

  @override
  String get recordVideoStoragePermissionAlert =>
      'Tu dois autoriser l\'utilisation du stockage dans les paramètres pour enregistrer des vidéos.';

  @override
  String get recordVideoMicrophonePermissionAlert =>
      'Tu dois autoriser l\'utilisation du micro dans les paramètres pour enregistrer des vidéos.';

  @override
  String get takePhotoStoragePermissionAlert =>
      'Tu dois autoriser l\'utilisation du stockage dans les paramètres pour prendre des photos.';

  @override
  String get takePhotoCameraPermissionAlert =>
      'Tu dois autoriser l\'utilisation de la caméra dans les paramètres pour prendre une photo.';

  @override
  String get pickPhotoStoragePermissionAlert =>
      'Tu dois autoriser l\'utilisation du stockage dans les paramètres pour choisir des photos.';
  ...
  String get atmosphereFeedDescription =>
      'Contribue dans le flux, en envoyant un message, un témoignage ou une photo prise là où tu te trouves.';
  ...
  String get photoNotSupported =>
      'Cet appareil ne prend pas en charge la prise ou la sélection de photos.';

  @override
  String get answerFailed =>
      'Désolé ! Ta réponse n\'a pas été envoyée. Merci de réessayer.';
  ...
  String get debugInfoExplanation =>
      'Ton message inclura cette information, pour nous aider à mieux comprendre le problème.';
  ...
  String get distanceRegistered =>
      'Ta distance a été enregistrée. Continue ci-dessous si tu souhaites enregistrer une nouvelle distance.';
  ...
  String get runningEffort =>
      'Quel effort impressionnant ! Inscris le nombre de kilomètres parcourus ci-dessous.';

  @override
  String get slideSelect =>
      'Fais défiler le menu déroulant pour choisir la distance parcourue';
  ...
  String get firstPostTitle =>
      'Sois le premier à envoyer une photo ou un message';
  ...
  String get uploadingInquirySuccess =>
      'Nous attirons l\'attention sur le fait que nous ne répondrons pas à toutes les questions posées pendant l\'émission.';
  ...
  String get submitQuestionInfo =>
      'En posant une question, tu acceptes qu\'elle soit utilisée dans le cadre de l\'émission.';
  ...
  String get submitPostInfo =>
      'En postant un message ou une photo, tu acceptes son utilisation dans le cadre de l\'émission. ';
  ...
  String get pollSingleChoice =>
      'Tu ne peux sélectionner qu\'une seule réponse à la fois.';

  @override
  String get pollMultipleChoice =>
      'Tu peux modifier ta réponse plusieurs fois.';
  ...
  String get browserInstall =>
      'Merci d\'installer un navigateur Web pour pouvoir ouvrir cet URL.';
  ...
  String get quizNotEnabled =>
      'Le quiz n\'est pas disponible pour le moment. Merci de retenter plus tard.';
  ...
  String get donationNotAvailable =>
      'Il n\'est pas possible de faire un don pour le moment. Merci de retenter plus tard.';
  ...
  String get participantsSubtitle =>
      'Sélectionne un ou plusieurs participants.';
  ...
  String get tokenError =>
      'Nous n\'avons pas pu confirmer ton identité, probablement en raison d\'un problème de réseau. Certaines fonctionnalités de l\'application peuvent ne pas fonctionner correctement.';
  ...
  @override
  String get scanInfo =>
      'Scanne le code avec ton téléphone pour accéder à la page de connexion.';
  ...
  String get confirmInfo =>
      'Après une connexion réussie sur ton appareil, clique sur le bouton ci-dessous pour confirmer ta connexion.';
  ...
  String get removeFromRecentSearches =>
      'Veux-tu supprimer cet élément des recherches récentes ?';
  ...
  String get reportProblem =>
      'En cas de problème, utilise le QR code ci-dessous pour nous envoyer un mail.';

  @override
  String get phoneReadingProblem =>
      'Si ton téléphone ne parvient pas à lire le QR code, envoie-nous un mail avec l\'information suivante à';
  ...
  String get authResponse0 =>
      'Merci d\'utiliser un nouveau QR code pour la connexion.';

  @override
  String get authResponse1 =>
      'Merci de te connecter sur ton portable en utilisant un QR code.';

  @override
  String get authResponse3 =>
      'Vérifie ta connexion internet et retente plus tard, merci.';
