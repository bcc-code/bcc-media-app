...
class ShortView extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    if (futureSnapshot.data?.parsedData == null && (futureSnapshot.error != null || futureSnapshot.data?.exception != null)) {
      return ErrorAdaptive(onRetry: onReloadRequested, exception: futureSnapshot.data?.exception);
    }
            ...
            onTap: () {
              ...
              showDialog(
                  ...
                  builder: (context) => AlertDialog(
                        ...
                        content:
                            Text(S.of(context).shortsTranscriptionDisclaimer, style: design.textStyles.body2.copyWith(color: design.colors.label1)),
                      ));
            },
            child: SizedBox(
              height: 20,
