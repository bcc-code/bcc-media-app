...
import 'package:brunstadtv_app/models/auth0/auth0_api.dart' as _i12;
...
class MockAuth0Api extends _i1.Mock implements _i5.Auth0Api {
  ...
  @override
  _i7.Future<_i12.Auth0SignupResponse?> signup(
          _i12.Auth0SignupRequestBody? requestBody) =>
      (super.noSuchMethod(
        Invocation.method(
          #signup,
          [requestBody],
        ),
        returnValue: _i7.Future<_i12.Auth0SignupResponse?>.value(),
        returnValueForMissingStub:
            _i7.Future<_i12.Auth0SignupResponse?>.value(),
      ) as _i7.Future<_i12.Auth0SignupResponse?>);
