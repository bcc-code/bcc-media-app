...
- (void)getPlaybackSpeed:(NSString *)playerId completion:(void (^)(NSNumber *_Nullable, FlutterError *_Nullable))completion;
- (void)setPlaybackSpeed:(NSString *)playerId playbackSpeed:(NSNumber *)playbackSpeed completion:(void (^)(FlutterError *_Nullable))completion;
