...
import 'package:bccm_player/src/widgets/controls/next_episode_button.dart';
...
class DefaultControls extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final showNextEpisodeIndicator = (this.showNextEpisodeIndicator ?? false) && duration > currentMs && (duration - currentMs) / 1000 <= 5;
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        IconButton(
                          iconSize: 54,
                          icon: Icon(player.value?.playbackState != PlaybackState.playing ? Icons.play_arrow : Icons.pause),
                          onPressed: () {
          ...
          if (showNextEpisodeIndicator)
            Align(
              ...
              child: Container(
                ...
                child: NextEpiosodeButton(
                  text: nextEpisodeButtonText,
                  action: onNextEpisodeTapped,
                ),
              ),
            ),
        ],
