...
public class PlaybackPlatformApi {
  ...
  public interface PlaybackPlatformPigeon {
    ...
    void getPlaybackSpeed(@NonNull String playerId, @NonNull Result<Double> result);

    void setPlaybackSpeed(@NonNull String playerId, @NonNull Double playbackSpeed, @NonNull Result<Void> result);
    ...
    static void setup(@NonNull BinaryMessenger binaryMessenger, @Nullable PlaybackPlatformPigeon api) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.PlaybackPlatformPigeon.getPlaybackSpeed", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
                ...
                api.getPlaybackSpeed(playerIdArg, resultCallback);
              });
        } else {
          channel.setMessageHandler(null);
        }
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.PlaybackPlatformPigeon.setPlaybackSpeed", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
                ArrayList<Object> args = (ArrayList<Object>) message;
                String playerIdArg = (String) args.get(0);
                Double playbackSpeedArg = (Double) args.get(1);
                Result<Void> resultCallback =
                    new Result<Void>() {
                      public void success(Void result) {
                        wrapped.add(0, null);
                ...
                api.setPlaybackSpeed(playerIdArg, playbackSpeedArg, resultCallback);
              });
        } else {
          channel.setMessageHandler(null);
        }
