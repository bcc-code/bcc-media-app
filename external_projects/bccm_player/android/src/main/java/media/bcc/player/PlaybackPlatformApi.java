...
public class PlaybackPlatformApi {
  ...
  /** Generated class from Pigeon that represents data sent in messages. */
  public static class FullscreenOverlayConfig {
    ...
    public @NonNull String getEntrypoint() { return entrypoint; }
    ...
    public @NonNull String getLibraryPath() { return libraryPath; }
    ...
    @NonNull Map<String, Object> toMap() {
      Map<String, Object> toMapResult = new HashMap<>();
      toMapResult.put("id", id);
      toMapResult.put("entrypoint", entrypoint);
      toMapResult.put("libraryPath", libraryPath);
    ...
    static @NonNull FullscreenOverlayConfig fromMap(@NonNull Map<String, Object> map) {
      FullscreenOverlayConfig pigeonResult = new FullscreenOverlayConfig();
      Object id = map.get("id");
      pigeonResult.setId((String)id);
      Object entrypoint = map.get("entrypoint");
      pigeonResult.setEntrypoint((String)entrypoint);
      Object libraryPath = map.get("libraryPath");
  ...
  private static class PlaybackPlatformPigeonCodec extends StandardMessageCodec {
    ...
    protected Object readValueOfType(byte type, ByteBuffer buffer) {
      switch (type) {
        ...
        case (byte)130:         
          return FullscreenOverlayConfig.fromMap((Map<String, Object>) readValue(buffer));
    ...
    protected void writeValue(ByteArrayOutputStream stream, Object value)     {
      ...
      if (value instanceof FullscreenOverlayConfig) {
        stream.write(130);
        writeValue(stream, ((FullscreenOverlayConfig) value).toMap());
      } else 
      ...
      } else 
{
  ...
  public interface PlaybackPlatformPigeon {
    ...
    static void setup(BinaryMessenger binaryMessenger, PlaybackPlatformPigeon api) {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.PlaybackPlatformPigeon.showFullscreenOverlay", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
